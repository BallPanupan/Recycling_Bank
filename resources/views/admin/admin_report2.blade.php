...
var options = {
	...
	data: [{
		...
		dataPoints: [
			{ label: "ประเภทเศษเหล็ก", y: 10.09 },
			{ label: "ประเภทเศษกระดาษ", y: 9.40 },
			{ label: "ประเภทขวดแก้ว", y: 8.50 },
			{ label: "ประเภทพลาสติก", y: 19.96 },
			{ label: "ประเภทโลหะมีค่าสูง", y: 7.80 },
			{ label: "ประเภทอื่นๆ", y: 7.56 },
